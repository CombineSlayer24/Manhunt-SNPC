...
SWEP.PrintName					= "Manhunt Heavy Handgun"
SWEP.Author 					= "DrVrej"
...
SWEP.NPC_NextPrimaryFire 		= 3.0 -- Next time it can use primary fire
SWEP.NPC_TimeUntilFire	 		= 0.1 -- How much time until the bullet/projectile is fired?
SWEP.NPC_TimeUntilFireExtraTimers = {0.75,1.5} -- Next time it can use primary fire
SWEP.NPC_UsePistolBehavior 		= true
SWEP.NPC_CustomSpread = 1.4
SWEP.NPC_AllowCustomSpread = true
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.HoldType 					= "pistol" -- List of holdtypes are in the GMod wiki
SWEP.WorldModel					= "models/manhunt/weapons/w_deagle.mdl"
