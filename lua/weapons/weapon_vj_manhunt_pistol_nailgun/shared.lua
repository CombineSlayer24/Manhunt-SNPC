...
SWEP.PrintName					= "Manhunt Nailgun"
SWEP.Author 					= "DrVrej"
...
SWEP.NPC_NextPrimaryFire 		= 2.8 -- Next time it can use primary fire
...
SWEP.WorldModel					= "models/manhunt/weapons/w_nailgun.mdl"
...
SWEP.Primary.Damage				= 9.5 -- Damage
...
SWEP.Primary.Sound				= {"weapons/pistol/fire_nailgun1.wav","weapons/pistol/fire_nailgun2.wav"}
SWEP.Primary.HasDistantSound	= true -- Does it have a distant sound when the gun is shot?
SWEP.Primary.DistantSound		= {"weapons/pistol/echo_nailgun1.wav","weapons/pistol/echo_nailgun2.wav"}
...
SWEP.NPC_ReloadSound = {"weapons/pistol/reload.wav"} -- Sounds it plays when the base detects the SNPC playing a reload animation
