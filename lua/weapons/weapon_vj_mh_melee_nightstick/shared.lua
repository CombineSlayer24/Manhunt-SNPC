...
SWEP.MeleeWeaponSound_Hit = {"vj_manhunt/weapons/melee/mh_melee_hit1.wav","vj_manhunt/weapons/melee/mh_melee_hit2.wav","vj_manhunt/weapons/melee/mh_melee_hit3.wav"}
