...
SWEP.PrintName					= "Manhunt Sub-Machine Gun"
SWEP.Author 					= "DrVrej"
...
SWEP.NPC_NextPrimaryFire 		= 2.4 -- Next time it can use primary fire
SWEP.NPC_TimeUntilFire	 		= 0.1 -- How much time until the bullet/projectile is fired?
SWEP.NPC_TimeUntilFireExtraTimers = {0.11,0.22,0.33,0.44,0.55,0.66,0.77,0.88,0.99} -- Next time it can use primary fire
SWEP.NPC_UsePistolBehavior 		= false
SWEP.NPC_CustomSpread = 1.48
SWEP.NPC_AllowCustomSpread = true
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.HoldType 					= "pistol" -- List of holdtypes are in the GMod wiki
SWEP.WorldModel					= "models/manhunt/weapons/w_uzi.mdl"
...
SWEP.Primary.Sound				= {"vj_manhunt/weapons/manhunt/uzifire.wav"}
SWEP.Primary.HasDistantSound	= true -- Does it have a distant sound when the gun is shot?
SWEP.Primary.DistantSound		= {"vj_manhunt/weapons/manhunt/uzifire_distant.wav"}

SWEP.Primary.DistantSoundLevel = 95 -- Distant sound level
