...
SWEP.Primary.Sound				= {"weapons/melee/melee_miss.wav"}
SWEP.Primary.HasDistantSound	= false -- Does it have a distant sound when the gun is shot?
SWEP.Primary.DistantSound		= {"weapons/melee/melee_miss.wav"}
...
self.Owner.DefaultSoundTbl_MeleeAttack = {"weapons/melee/melee_hit1.wav","weapons/melee/melee_hit4.wav","weapons/melee/melee_hit5.wav"}
self.Owner.DefaultSoundTbl_MeleeAttackMiss = {"weapons/melee/melee_miss.wav"}
...
//Animations break with first RandAnim
-- function SWEP:CustomOnThink() 
...
-- 		self.Owner.AnimTbl_ShootWhileMovingWalk = {ACT_WALK}
-- 		self.Owner.AnimTbl_ShootWhileMovingRun = {ACT_RUN}
-- 		self.Owner.WeaponReloadAnimationFaceEnemy = false
-- 		self.Owner.HasWeaponBackAway = true
-- 		self.Owner.WeaponBackAway_Distance = 40		
-- 		self.Owner.AllowWeaponReloading = true
...
self.Owner:VJ_ACT_PLAYACTIVITY(ACT_HL2MP_IDLE_FIST,false,0.01,false,1,{SequenceDuration=self.DeathFlinchTime})
	...
	pain = self.Primary.Damage * damagedice
			self.Weapon:EmitSound("weapons/melee/melee_miss.wav")--slash in the wind sound here
