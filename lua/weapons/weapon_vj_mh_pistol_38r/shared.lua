...
SWEP.NPC_NextPrimaryFire 		= 3.6 -- Next time it can use primary fire
SWEP.NPC_TimeUntilFire	 		= 0.1 -- How much time until the bullet/projectile is fired?
SWEP.NPC_TimeUntilFireExtraTimers = {0.9,1.8} -- Next time it can use primary fire
...
SWEP.NPC_ReloadSound = {"vj_manhunt/weapons/manhunt/reload_hgun.wav"} -- Sounds it plays when the base detects the SNPC playing a reload animation
