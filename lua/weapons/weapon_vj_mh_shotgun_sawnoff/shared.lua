...
SWEP.PrintName					= "Manhunt Sawn-Off Shotgun"
SWEP.Author 					= "DrVrej"
...
SWEP.NPC_NextPrimaryFire 		= 4.75 -- Next time it can use primary fire
...
SWEP.Primary.Sound				= {"vj_manhunt/weapons/manhunt/shotgun.wav"}
SWEP.Primary.HasDistantSound	= true -- Does it have a distant sound when the gun is shot?
SWEP.Primary.DistantSound		= {"vj_manhunt/weapons/manhunt/shotgun_distant.wav"}
...
SWEP.NPC_ReloadSound = {"vj_manhunt/weapons/manhunt/reload_shotgun.wav"} -- Sounds it plays when the base detects the SNPC playing a reload animation
