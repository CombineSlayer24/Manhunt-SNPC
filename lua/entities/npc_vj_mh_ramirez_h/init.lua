...
function ENT:CustomOnTakeDamage_BeforeDamage(dmginfo, hitgroup)
	...
	if dmginfo:IsBulletDamage() and hitgroup == HITGROUP_HEAD then
		if GetConVarNumber("vj_manhunt_hunters_headshot_sound") == 1 then VJ_EmitSound(self, "vj_manhunt/vocals/zmb_vj_manhunt/vocals/headshot_"..math.random(0,6)..".wav", 70) end
