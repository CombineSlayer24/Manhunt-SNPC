...
-----------------------------------------------*/
ENT.Model = {"models/manhunt/npc/undead/cerberus_undead.mdl"}
ENT.StartHealth = 225
...
function ENT:CustomOnInitialize()
	...
	if GetConVarNumber("vj_manhunt_hunters_zmb_eyeglow") == 1 then
		...
		eyeglow1:Spawn()
		eyeglow1:Activate()
		util.SpriteTrail(self,2,color,true,8,8,0.125,1/(6+12)*0.5,"VJ_Base/sprites/vj_trial1.vmt")
		self:DeleteOnRemove(eyeglow1)

		eyeglow2 = ents.Create("env_sprite")
		eyeglow2:SetKeyValue("model","vj_base/sprites/vj_glow1.vmt")
		eyeglow2:SetKeyValue("scale","0.05")
		...
		eyeglow2:Spawn()
		eyeglow2:Activate()
		util.SpriteTrail(self,1,color,true,8,8,0.125,1/(6+12)*0.5,"VJ_Base/sprites/vj_trial1.vmt")
	...
	if GetConVarNumber("vj_manhunt_hunters_zmb_faster") == 0 then 
		...
		if random_supersprint == 0 then // Random super sprinter
			self.AnimTbl_Run = {ACT_RUN}
		elseif random_supersprint == 8 then // super sonic sprint
			self.AnimTbl_Run = {ACT_SPRINT}
...
function ENT:ZombieWeapons()
	...
	if Weapon == 1 then
			...
			self.ExtraGunModel1:SetModel("models/Manhunt/weapons/w_m16.mdl")
		...
		elseif Weapon == 2 then
			...
			self.ExtraGunModel1 = ents.Create("prop_physics")
			self.ExtraGunModel1:SetModel("models/Manhunt/weapons/w_deagle.mdl")
			self.ExtraGunModel1:SetLocalPos(self:GetPos())
			//self.ExtraGunModel1:SetPos(self:GetPos())
			self.ExtraGunModel1:SetOwner(self)
			self.ExtraGunModel1:SetParent(self)
		...
		elseif Weapon == 3 then
			...
			self.ExtraGunModel1 = ents.Create("prop_physics")
			self.ExtraGunModel1:SetModel("models/manhunt/weapons/w_uzi.mdl")
			self.ExtraGunModel1:SetLocalPos(self:GetPos())
			//self.ExtraGunModel1:SetPos(self:GetPos())
			self.ExtraGunModel1:SetOwner(self)
			self.ExtraGunModel1:SetParent(self)
		...
		elseif Weapon == 4 then
			...
			self.ExtraGunModel1 = ents.Create("prop_physics")
			self.ExtraGunModel1:SetModel("models/manhunt/weapons/w_nightstick.mdl")
			self.ExtraGunModel1:SetLocalPos(self:GetPos())
			//self.ExtraGunModel1:SetPos(self:GetPos())
			self.ExtraGunModel1:SetOwner(self)
			self.ExtraGunModel1:SetParent(self)
		...
		elseif Weapon == 5 then
			...
			self.ExtraGunModel1 = ents.Create("prop_physics")
			self.ExtraGunModel1:SetModel("models/manhunt/weapons/w_knife.mdl")
			self.ExtraGunModel1:SetLocalPos(self:GetPos())
			//self.ExtraGunModel1:SetPos(self:GetPos())
			self.ExtraGunModel1:SetOwner(self)
			self.ExtraGunModel1:SetParent(self)
		...
		elseif Weapon == 6 then
			self.SoundTbl_MeleeAttack = 
			{
				"vj_manhunt/weapons/melee/bat_m_hit.wav",
				"vj_manhunt/weapons/melee/bat_m_hit1.wav",
				"vj_manhunt/weapons/melee/bat_m_hit2.wav"
			}
			self.SoundTbl_MeleeAttackMiss = 
			{
				"vj_manhunt/weapons/melee/mh_melee_miss.wav"
			...
			self.ExtraGunModel1 = ents.Create("prop_physics")
			self.ExtraGunModel1:SetModel("models/manhunt/weapons/w_mbat.mdl")
			self.ExtraGunModel1:SetLocalPos(self:GetPos())
			//self.ExtraGunModel1:SetPos(self:GetPos())
			self.ExtraGunModel1:SetOwner(self)
			self.ExtraGunModel1:SetParent(self)
		...
		elseif Weapon == 7 then
			self.SoundTbl_MeleeAttack = 
			{
				"vj_manhunt/weapons/melee/crowbar_hit1.wav",
				"vj_manhunt/weapons/melee/crowbar_hit2.wav",
				"vj_manhunt/weapons/melee/crowbar_hit3.wav"
			}
			self.SoundTbl_MeleeAttackMiss = 
			{
				"vj_manhunt/weapons/melee/mh_melee_miss.wav"
			...
			self.ExtraGunModel1 = ents.Create("prop_physics")
			self.ExtraGunModel1:SetModel("models/manhunt/weapons/w_crowbar.mdl")
			self.ExtraGunModel1:SetLocalPos(self:GetPos())
			//self.ExtraGunModel1:SetPos(self:GetPos())
			self.ExtraGunModel1:SetOwner(self)
			self.ExtraGunModel1:SetParent(self)
...
function ENT:Gibs(gType)
	if gType == "headgib" then
		if self:GetModel() == "models/manhunt/npc/undead/cerberus_undead.mdl" then
