...
function ENT:CustomOnInitialize()
	...
	if GetConVarNumber("vj_manhunt_hunters_allied") == 0 then
		self.VJ_NPC_Class = {"CLASS_MANHUNT_CCPD_FRIENDLY","CLASS_MANHUNT_WARDOGS_FRIENDLY","CLASS_MANHUNT_CERBERUS_FRIENDLY","CLASS_MANHUNT_SMILIES_FRIENDLY","CLASS_PLAYER_ALLY"}
	end
