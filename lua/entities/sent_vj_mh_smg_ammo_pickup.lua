...
function ENT:Use(activator, caller) -- Gives ammo when pressing the "Use" key
	if activator:IsPlayer() then
        ...
        if ammo_random == 1 then
            caller:GiveAmmo(1, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (1)" )
        elseif ammo_random == 2 then
            caller:GiveAmmo(1, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (1)" )
        elseif ammo_random == 3 then
            caller:GiveAmmo(2, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (2)" )
        elseif ammo_random == 4 then
            caller:GiveAmmo(3, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (3)" )
        ...
        elseif ammo_random == 6 then
            ...
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (6)" )
        elseif ammo_random == 7 then
            caller:GiveAmmo(8, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (8)" )
        ...
        elseif ammo_random == 9 then
            ...
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (10)" )
        elseif ammo_random == 10 then
            caller:GiveAmmo(12, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (12)" )
        ...
        elseif ammo_random == 12 then
            ...
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (15)" )
        elseif ammo_random == 13 then
            caller:GiveAmmo(24, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (24)" )
        elseif ammo_random == 14 then
            caller:GiveAmmo(7, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (7)" )
        elseif ammo_random == 15 then
            caller:GiveAmmo(7, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (7)" )
        elseif ammo_random == 16 then
            caller:GiveAmmo(14, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (14)" )
        elseif ammo_random == 17 then
            caller:GiveAmmo(13, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (13)" )
        elseif ammo_random == 18 then
            caller:GiveAmmo(5, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (5)" )
        elseif ammo_random == 19 then
            caller:GiveAmmo(5, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (5)" )
        elseif ammo_random == 20 then
            caller:GiveAmmo(4, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (4)" )
        elseif ammo_random == 21 then
            caller:GiveAmmo(4, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (4)" )
        elseif ammo_random == 22 then
            caller:GiveAmmo(11, "SMG1", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, "SMG Ammo (11)" )
