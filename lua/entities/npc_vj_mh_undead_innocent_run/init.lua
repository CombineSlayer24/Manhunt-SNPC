...
-----------------------------------------------*/
ENT.Model = {"models/manhunt/npc/undead/innocent1_undead.mdl","models/manhunt/npc/undead/innocent2_undead.mdl","models/manhunt/npc/undead/innocent3_undead.mdl"}
ENT.StartHealth = 150
...
function ENT:ZombieWeapons()
	...
	if Weapon == 1 then
			...
			self.ExtraGunModel1:SetModel("models/Manhunt/weapons/w_axe.mdl")
		...
		elseif Weapon == 3 then
			...
			self.ExtraGunModel1 = ents.Create("prop_physics")
			self.ExtraGunModel1:SetModel("models/manhunt/weapons/w_sickle.mdl")
			self.ExtraGunModel1:SetLocalPos(self:GetPos())
			//self.ExtraGunModel1:SetPos(self:GetPos())
			self.ExtraGunModel1:SetOwner(self)
			self.ExtraGunModel1:SetParent(self)
...
function ENT:Gibs(gType)
	if gType == "headgib" then
		if self:GetModel() == "models/manhunt/npc/undead/innocent1_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
		if self:GetModel() == "models/manhunt/npc/undead/innocent2_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
		if self:GetModel() == "models/manhunt/npc/undead/innocent3_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
	end
end
