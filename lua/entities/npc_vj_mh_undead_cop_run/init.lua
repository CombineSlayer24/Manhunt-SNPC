...
-----------------------------------------------*/
ENT.Model = {"models/manhunt/npc/undead/cop3_undead.mdl","models/manhunt/npc/undead/cop1_undead.mdl"}
ENT.StartHealth = 150
...
function ENT:Gibs(gType)
	if gType == "headgib" then
		if self:GetModel() == "models/manhunt/npc/undead/cop1_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
		if self:GetModel() == "models/manhunt/npc/undead/cop3_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
	end
end
