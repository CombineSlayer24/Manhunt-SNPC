...
ENT.Model = {"models/manhunt/npc/undead/hood1_undead.mdl","models/manhunt/npc/undead/hood2_undead.mdl","models/manhunt/npc/undead/hood3_undead.mdl"}
...
function ENT:ZombieWeapons()
    ...
    if self.LNR_CanUseWeapon then
		...
		if Weapon == 1 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_blackjack.mdl")
			self.SoundTbl_MeleeAttack = 
			{
		...
		elseif Weapon == 3 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_brick.mdl")
			self.SoundTbl_MeleeAttack = 
			{
		...
		elseif Weapon == 5 then
			self.WeaponModel:SetModel("models/manhunt/weapons/w_hammer.mdl")
			self.SoundTbl_MeleeAttack = 
			{
...
function ENT:Gibs(gType)
	if gType == "headgib" then
		if self:GetModel() == "models/manhunt/npc/undead/hood1_undead.mdl" then
			self:SetBodygroup(1,math.random(1,3))
		end
		if self:GetModel() == "models/manhunt/npc/undead/hood2_undead.mdl" then
			self:SetBodygroup(1,math.random(1,3))
		end
		if self:GetModel() == "models/manhunt/npc/undead/hood3_undead.mdl" then
			self:SetBodygroup(1,math.random(1,3))
		end
	end
end
