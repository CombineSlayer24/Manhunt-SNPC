...
function ENT:ZombieWeapons()
    ...
    if self.LNR_CanUseWeapon then
		...
		elseif Weapon == 5 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_sickle.mdl")
			self.SoundTbl_MeleeAttack = 
			{
		...
		elseif Weapon == 6 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_knife.mdl")
			self.SoundTbl_MeleeAttack = 
			{
				"vj_manhunt/weapons/melee/mh_blade_hit1.wav",
				"vj_manhunt/weapons/melee/mh_blade_hit2.wav",
		...
		elseif Weapon == 7 then
			self.WeaponModel:SetModel("models/manhunt/weapons/w_crowbar.mdl")
			self.SoundTbl_MeleeAttack = 
			{
