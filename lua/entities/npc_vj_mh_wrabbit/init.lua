...
-----------------------------------------------*/
ENT.Model = {"models/manhunt/npc/rabbit.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
function ENT:CustomOnInitialize()
	...
	if GetConVarNumber("vj_manhunt_hunters_allied") == 0 then
		self.VJ_NPC_Class = {"CLASS_MANHUNT_SMILIES_FRIENDLY","CLASS_MANHUNT_CERBERUS_FRIENDLY","CLASS_PLAYER_ALLY"}
	end
...
ENT.SoundTbl_Alert = 
{
	"vj_manhunt/vocals/characters/wrabbit/b1v1bp1.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1bp2.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1bp3.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1bp4.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1bp5.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1bp6.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1prs1.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1prs2.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1prs3.mp3"
}
...
{
	"vj_manhunt/vocals/characters/wrabbit/b1v1pln1.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1pln2.mp3",
	"vj_manhunt/vocals/characters/wrabbit/b1v1pln3.mp3"
}
ENT.SoundTbl_Idle = 
{
	"vj_manhunt/vocals/characters/wrabbit/b1v1bp4.mp3",
...
function ENT:Gibs(gType)
	if gType == "headgib" then
		if self:GetModel() == "models/manhunt/npc/rabbit.mdl" then
