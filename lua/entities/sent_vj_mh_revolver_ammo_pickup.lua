...
if CLIENT then -- Spinning code
    ...
    function ENT:Draw()
        self:DrawModel()
        self.Spin = self.Spin + FrameTime()*-35
...
function ENT:Use(activator, caller) -- Gives ammo when pressing the "Use" key
	if activator:IsPlayer() then
        ...
        if ammo_random == 1 then
            caller:GiveAmmo(1, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (1)" )
        ...
        elseif ammo_random == 3 then
            ...
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (2)" )
        ...
        elseif ammo_random == 5 then
            ...
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (3)" )
        elseif ammo_random == 6 then
            caller:GiveAmmo(3, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (3)" )
        elseif ammo_random == 7 then
            caller:GiveAmmo(4, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (4)" )
        elseif ammo_random == 8 then
            caller:GiveAmmo(4, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (4)" )
        elseif ammo_random == 9 then
            caller:GiveAmmo(5, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (5)" )
        ...
        elseif ammo_random == 11 then
            ...
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (6)" )
        elseif ammo_random == 12 then
            caller:GiveAmmo(6, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (6)" )
        elseif ammo_random == 13 then
            caller:GiveAmmo(7, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (7)" )
        elseif ammo_random == 14 then
            caller:GiveAmmo(8, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (8)" )
        elseif ammo_random == 15 then
            caller:GiveAmmo(9, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (9)" )
        elseif ammo_random == 16 then
            caller:GiveAmmo(10, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (10)" )
        elseif ammo_random == 17 then
            caller:GiveAmmo(12, "357", true)
            activator:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            activator:PrintMessage(HUD_PRINTTALK, ".357 Ammo (12)" )
        end
		self:Remove()
	end
end