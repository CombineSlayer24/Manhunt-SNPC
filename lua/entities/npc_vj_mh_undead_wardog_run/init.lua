...
ENT.Model = {"models/manhunt/npc/undead/wardog1_undead.mdl","models/manhunt/npc/undead/wardog2_undead.mdl","models/manhunt/npc/undead/wardog3_undead.mdl"}
...
function ENT:ZombieWeapons()
    ...
    if self.LNR_CanUseWeapon then
		...
		if Weapon == 1 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_rifle.mdl")
			self.SoundTbl_MeleeAttack = 
			{
		...
		elseif Weapon == 2 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_revolver.mdl")
			self.SoundTbl_MeleeAttack = 
			{
				"vj_manhunt/weapons/melee/mh_melee_hit1.wav",
				"vj_manhunt/weapons/melee/mh_melee_hit2.wav",
		...
		elseif Weapon == 3 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_wbat.mdl")
			self.SoundTbl_MeleeAttack = 
			{
		...
		elseif Weapon == 5 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_machete.mdl")
			self.SoundTbl_MeleeAttack = 
			{
		...
		elseif Weapon == 6 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_sawnoff.mdl")
			self.SoundTbl_MeleeAttack = 
			{
				"vj_manhunt/weapons/melee/bat_m_hit.wav",
				"vj_manhunt/weapons/melee/bat_m_hit1.wav",
		...
		elseif Weapon == 7 then
			self.WeaponModel:SetModel("models/manhunt/weapons/w_nailbat.mdl")
			self.SoundTbl_MeleeAttack = 
			{
				"vj_manhunt/weapons/melee/mh_melee_hit1.wav",
				"vj_manhunt/weapons/melee/mh_melee_hit2.wav",
...
function ENT:Gibs(gType)
	if gType == "headgib" then
		if self:GetModel() == "models/manhunt/npc/undead/wardog1_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
		if self:GetModel() == "models/manhunt/npc/undead/wardog2_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
		if self:GetModel() == "models/manhunt/npc/undead/wardog3_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
	end
end
