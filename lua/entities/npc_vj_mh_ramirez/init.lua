...
-----------------------------------------------*/
ENT.Model = {"models/manhunt/npc/ramirez.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
function ENT:CustomOnInitialize()
	...
	if GetConVarNumber("vj_manhunt_hunters_allied") == 0 then
		self.VJ_NPC_Class = {"CLASS_MANHUNT_SKINZ_FRIENDLY","CLASS_MANHUNT_WARDOGS_FRIENDLY","CLASS_MANHUNT_INNOCENTZ_FRIENDLY","CLASS_MANHUNT_CERBERUS_FRIENDLY","CLASS_PLAYER_ALLY"}
	end
...
ENT.SoundTbl_Alert = 
{
	"vj_manhunt/vocals/characters/ramirez/r1v1ds1.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds2.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds3.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds4.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds5.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds6.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds7.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds8.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds9.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds10.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds11.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds12.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds13.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds14.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds15.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds16.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds17.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds18.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds19.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds20.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds21.mp3"
}
ENT.SoundTbl_BecomeEnemyToPlayer = 
{
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc3.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ds11.mp3"
}
ENT.SoundTbl_AllyDeath =
{
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram6.mp3"
}
ENT.SoundTbl_CombatIdle = 
{
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh1.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh2.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh3.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh4.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh5.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh6.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh7.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh8.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh9.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsh10.mp3"
}
ENT.SoundTbl_IdleDialogueAnswer = 
{
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram7.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram2.mp3"
}
ENT.SoundTbl_IdleDialogue = 
{
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram11.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram12.mp3"
}
ENT.SoundTbl_Idle = 
{
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram1.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram2.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram3.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram4.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram5.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram6.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram7.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram8.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram9.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram10.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram11.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram12.mp3",
	"vj_manhunt/vocals/characters/ramirez/scripted/r1v1ram13.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz1.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz2.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz3.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz4.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz5.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz6.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz7.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz8.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz9.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1tsz10.mp3"
}
...
{
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc6.mp3"
}
...
{
	"vj_manhunt/vocals/characters/ramirez/r1v1bp2.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1bp3.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1bp4.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1bp5.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1bp6.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc1.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc2.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc3.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc4.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc5.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc6.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc7.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc8.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc9.mp3",
	"vj_manhunt/vocals/characters/ramirez/r1v1ptc10.mp3"
}
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomOnTakeDamage_BeforeDamage(dmginfo, hitgroup)
	-- Absorb bullet damage
	if dmginfo:IsBulletDamage() then
		if self.HasSounds == true && self.HasImpactSounds == true then VJ_EmitSound(self, "vj_manhunt/weapons/bloody_impact"..math.random(1,11)..".wav", 70) end
...
function ENT:Gibs(gType)
	if gType == "headgib" then
		if self:GetModel() == "models/manhunt/npc/ramirez.mdl" then
...
function ENT:SetUpGibesOnDeath(dmginfo, hitgroup)
	...
	local gibchance = math.random(1,6)
	...
	if hitgroup == HITGROUP_HEAD then
		...
		elseif gibchance == 3 then
			...
			self:CreateGibEntity("obj_vj_gib_manhunt","models/gibs/humans/eye_gib.mdl",{Pos=self:LocalToWorld(Vector(0,0,65)),Ang=self:GetAngles()+Angle(0,-90,0),Vel=self:GetRight()*math.Rand(150,250)+self:GetForward()*math.Rand(-200,200)})
			self:Gibs("headgib")
		elseif gibchance == 4 then
			util.Effect("bloodspray",bloodspray)
		elseif gibchance == 5 then
			util.Effect("bloodspray",bloodspray)
		elseif gibchance == 6 then
			util.Effect("bloodspray",bloodspray)
		end
	end
end
