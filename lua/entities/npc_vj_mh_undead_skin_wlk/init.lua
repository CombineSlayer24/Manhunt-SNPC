...
ENT.Model = {"models/manhunt/npc/undead/skin1_undead.mdl","models/manhunt/npc/undead/skin2_undead.mdl","models/manhunt/npc/undead/skin3_undead.mdl"}
...
function ENT:ZombieWeapons()
    ...
    if self.LNR_CanUseWeapon then
		...
		if Weapon == 1 then
			self.WeaponModel:SetModel("models/Manhunt/weapons/w_nailgun.mdl")
			self.SoundTbl_MeleeAttack = 
			{
...
function ENT:Gibs(gType)
	if gType == "headgib" then
		if self:GetModel() == "models/manhunt/npc/undead/skin1_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
		if self:GetModel() == "models/manhunt/npc/undead/skin2_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
		if self:GetModel() == "models/manhunt/npc/undead/skin3_undead.mdl" then
			self:SetBodygroup(1,math.random(1,4))
		end
	end
end
