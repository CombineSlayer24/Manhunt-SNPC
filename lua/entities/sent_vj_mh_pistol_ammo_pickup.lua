...
function ENT:Touch(ply) -- when we touch this, pick it up
	...
	if ply:IsPlayer() then
        ...
        if ammo_random == 1 then
            ...
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (1)" )
        elseif ammo_random == 2 then
            ply:GiveAmmo(1, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (1)" )
        elseif ammo_random == 3 then
            ply:GiveAmmo(2, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (2)" )
        elseif ammo_random == 4 then
            ply:GiveAmmo(3, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (3)" )
        elseif ammo_random == 5 then
            ply:GiveAmmo(3, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (3)" )
        elseif ammo_random == 6 then
            ply:GiveAmmo(6, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (6)" )
        elseif ammo_random == 7 then
            ply:GiveAmmo(8, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (8)" )
        elseif ammo_random == 8 then
            ply:GiveAmmo(8, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (8)" )
        elseif ammo_random == 9 then
            ply:GiveAmmo(10, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (10)" )
        elseif ammo_random == 10 then
            ply:GiveAmmo(12, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (12)" )
        ...
        elseif ammo_random == 13 then
            ...
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (24)" )
        elseif ammo_random == 14 then
            ply:GiveAmmo(7, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (7)" )
        elseif ammo_random == 15 then
            ply:GiveAmmo(7, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (7)" )
        elseif ammo_random == 16 then
            ply:GiveAmmo(14, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (14)" )
        elseif ammo_random == 17 then
            ply:GiveAmmo(13, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (13)" )
        elseif ammo_random == 18 then
            ply:GiveAmmo(5, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (5)" )
        elseif ammo_random == 19 then
            ply:GiveAmmo(5, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (5)" )
        elseif ammo_random == 20 then
            ply:GiveAmmo(4, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (4)" )
        elseif ammo_random == 21 then
            ply:GiveAmmo(4, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (4)" )
        elseif ammo_random == 22 then
            ply:GiveAmmo(11, "Pistol", true)
            ply:EmitSound(Sound("weapons/pickup_wep.wav"), 70, 100)
            ply:PrintMessage(HUD_PRINTTALK, "Pistol Ammo (11)" )
