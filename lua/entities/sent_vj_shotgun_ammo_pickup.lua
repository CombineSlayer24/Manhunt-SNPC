...
ENT.Type 			= "anim"
ENT.PrintName 		= "Shotgun Shells (Spining)"
ENT.Author 			= "DrVrej"
...
hook.Add( "PreDrawHalos", "AddShotg_Ammo_Halo", function()
	halo.Add( ents.FindByClass( "sent_vj_shotgun_ammo_pickup*" ), color_org, 8, 8, 5 )
end )
...
function ENT:SpawnFunction(ply, tr)
        ...
        local ent = ents.Create("sent_vj_shotgun_ammo_pickup")
        ...
        ent.CoronaOrb:SetLocalPos(ent:GetPos() + ent:GetUp()*1)
        ent.CoronaOrb:Spawn()
        ...
        ent.CoronaOrb2:SetLocalPos(ent:GetPos() + ent:GetUp()*1)
        ...
        ent.CoronaOrb3:SetLocalPos(ent:GetPos() + ent:GetUp()*1)
...
function ENT:Initialize()
        ...
        local model = ("models/manhunt/weapons/w_shotgunammo.mdl")
...
function ENT:Use(activator, caller) -- Gives ammo when pressing the "Use" key
	if activator:IsPlayer() then
		...
		activator:PrintMessage(HUD_PRINTTALK, "Shotgun Shells (8)" )
		self:Remove()
	end
end